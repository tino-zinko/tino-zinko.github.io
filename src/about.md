最終更新日: 2026/03/02 ([変更履歴](./release_notes.md))
...
🚧 現在のランキングの表示機能はメンテナンス中です。再開時期は未定です
...
- `アラーム`: `@alarm heart`と同義(頻繁に使用されるので、入力しやすいショートカットを用意しました。アットマーク`@`は不要です)
